                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    <tbody><tr>
                                        ...
                                        <th class="text-center">First Overdue Inst. Date</th>
                                        ...
                                        <th>Actions</th>
                                            ...
                                            <td class="text-center">1 Sep 2023</td>
                                                ...
                                                <div class="btn-group dropdown table-actions">
                                                    ...
                                                    <div class="dropdown-menu text-left webinars-lists-dropdown">
                                                                ...
                                                                <span class="ml-2">Send Message</span>
                                                                                                                    ...
                                                                                                                    <button class="btn-transparent text-primary d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm mt-1 trigger--fire-modal-1" data-confirm="Are you sure? | Do you want to continue?" data-confirm-href="/admin/financial/installments/orders/2/cancel" data-confirm-text-yes="Yes" data-confirm-text-cancel="Cancel">
            <i class="fa fa-times"></i><span class="ml-2">Cancel</span>
    </button>


                                                            <button class="btn-transparent text-primary d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm mt-1 trigger--fire-modal-2" data-confirm="Are you sure? | Do you want to continue?" data-confirm-href="/admin/financial/installments/orders/2/refund" data-confirm-text-yes="Yes" data-confirm-text-cancel="Cancel">

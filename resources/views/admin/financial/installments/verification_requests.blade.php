                            ...
                            <div class="table-responsive-2">
                                <table class="table table-striped font-14">
                                    <tbody><tr>
                                        ...
                                        <th class="text-center">Installments Amount</th>
                                        <th class="text-center">Requests Date</th>
                                        ...
                                        <th>Actions</th>
                                            ...
                                            <td class="text-left">
                                                <div class="d-flex align-items-center">
                                                    <figure class="avatar mr-2">
                                                        <img src="https://lms.rocket-soft.org/store/930/avatar/617a4ee75dd14.png" alt="Jade Harrison">
                                                    </figure>
                                                    <div class="media-body ml-1">
                                                        <div class="mt-0 mb-1 font-weight-bold">Jade Harrison</div>

                                                                                                                    <div class="text-primary text-small font-600-bold">+12025550130</div>
                                                        
                                                                                                                    <div class="text-primary text-small font-600-bold">jadeharrison@gmail.com</div>
                                                                                                            </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-center">3 Jun 2023</td>
                                            ...
                                            <td>
                                                <div class="btn-group dropdown table-actions">
                                                    ...
                                                    <div class="dropdown-menu text-left webinars-lists-dropdown">
                                                                                                                                                                                    ...
                                                                                                                                                                                    <button class="btn-transparent text-primary d-flex align-items-center text-success text-decoration-none btn-transparent btn-sm mb-1 trigger--fire-modal-1" data-confirm="Are you sure? | Do you want to continue?" data-confirm-href="#" data-confirm-text-yes="Yes" data-confirm-text-cancel="Cancel">
            <i class="fa fa-check"></i><span class="ml-2">Approve</span>
    </button>

                                                                <button class="btn-transparent text-primary d-flex align-items-center text-danger text-decoration-none btn-transparent btn-sm mb-1 trigger--fire-modal-2" data-confirm="Are you sure? | Do you want to continue?" data-confirm-href="#" data-confirm-text-yes="Yes" data-confirm-text-cancel="Cancel">
            <i class="fa fa-check"></i><span class="ml-2">Reject</span>
    </button>

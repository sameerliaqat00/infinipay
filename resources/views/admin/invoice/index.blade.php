...
@section('page_title', __('Invoice List'))

@section('content')
	<div class="main-content">
		<section class="section">
			<div class="section-header">
				<h1>@lang('Invoice List')</h1>
				<div class="section-header-breadcrumb">
					<div class="breadcrumb-item active">
						<a href="{{ route('admin.home') }}">@lang('Dashboard')</a>
					</div>
					<div class="breadcrumb-item">@lang('Invoice List')</div>
				</div>
			</div>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card mb-4 card-primary shadow-sm">
								...
								<div class="card-body">
									@if(isset($userId))
										<form action="{{ route('admin.user.invoice.search',$userId) }}" method="get">
											@include('admin.invoice.searchForm')
										</form>
									@else
									...
									<div class="table-responsive">
										<table
											...
											@forelse($invoices as $key => $value)
												<tr>
													<td data-label="@lang('SL')">{{loopIndex($invoices) + $key }}</td>
													...
													<td data-label="@lang('Amount')">{{ getAmount($value->grand_total).' '.__(optional($value->currency)->code) }}</td>

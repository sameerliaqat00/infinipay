<div class="row">
	...
	<div class="col-md-2">
		<div class="form-group">
			<input placeholder="@lang('Transaction ID')" name="hash_slug" value="{{ $search['utr'] ?? '' }}" type="text" class="form-control form-control-sm">
		</div>
	</div>
	<div class="col-md-2">
		<div class="form-group">
	...
	<div class="col-md-2">
		<div class="form-group search-currency-dropdown">
			<select name="status" class="form-control form-control-sm">
				...
				<option value="paid" {{ isset($search['status']) && $search['status'] == 'paid' ? 'selected' : '' }}>@lang('Paid')</option>
				<option value="unpaid" {{ isset($search['status']) && $search['status'] == 'unpaid' ? 'selected' : '' }}>@lang('UnPaid')</option>
				<option value="rejected" {{ isset($search['status']) && $search['status'] == 'rejected' ? 'selected' : '' }}>@lang('Rejected')</option>
			</select>
		</div>
	</div>
	<div class="col-md-2">

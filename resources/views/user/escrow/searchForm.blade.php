<div class="row">
	...
	<div class="col-md-2">
		<div class="form-group">
			<input placeholder="@lang('Minimum Amount')" name="min" value="{{ $search['min'] ?? '' }}" type="text" class="form-control form-control-sm">
		</div>
	</div>
	<div class="col-md-2">
		<div class="form-group">
	...
	<div class="col-md-2">
		<div class="form-group search-currency-dropdown">
			<select name="status" class="form-control form-control-sm">
				...
				<option value="1" {{ isset($search['status']) && $search['status'] == '1' ? 'selected' : ''}}>@lang('Generated')</option>
				<option value="2" {{ isset($search['status']) && $search['status'] == '2' ? 'selected' : ''}}>@lang('Payment done')</option>
				<option value="3" {{ isset($search['status']) && $search['status'] == '3' ? 'selected' : ''}}>@lang('Request for payment')</option>
				<option value="4" {{ isset($search['status']) && $search['status'] == '4' ? 'selected' : ''}}>@lang('Payment disbursed')</option>
				<option value="5" {{ isset($search['status']) && $search['status'] == '5' ? 'selected' : ''}}>@lang('Cancel')</option>
			</select>
		</div>
	</div>
	<div class="col-md-2">

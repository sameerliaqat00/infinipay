...
@section('page_title',__('Attribute Create'))

@section('content')
	<div class="main-content">
		<section class="section">
			<div class="section-header">
				<h1>@lang('Attribute Create')</h1>
				<div class="section-header-breadcrumb">
					<div class="breadcrumb-item active">
						<a href="{{ route('user.dashboard') }}">@lang('Dashboard')</a>
					</div>
					<div class="breadcrumb-item">@lang('Attribute Create')</div>
				</div>
			</div>
			<div class="row mb-3">
						...
						<div class="col-md-6">
							<div class="card mb-4 card-primary shadow">
								<div
									...
									<h6 class="m-0 font-weight-bold text-primary">@lang('Attribute Create')</h6>
								</div>
								<div class="card-body">
									<form action="{{ route('attr.create') }}" method="post">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label for="Attribute Name">@lang('Attribute Name') <sup
										...
										<button type="submit"
												class="btn btn-primary btn-sm">@lang('Create Attribute')</button>
									</form>
								</div>
							</div>
						</div>
